...
let SchoolService = class SchoolService {
    constructor(http) {
        this.http = http;
        this.collegeUrl = '../school.ctl'; //sevlet的相对路径，
    }
...
let CollegeDetaillComponent = class CollegeDetaillComponent {
    constructor(route, schoolService, location) {
        this.route = route;
        this.schoolService = schoolService;
        this.location = location;
...
CollegeDetaillComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _school_service__WEBPACK_IMPORTED_MODULE_4__["SchoolService"] },
    { type: _angular_common__WEBPACK_IMPORTED_MODULE_3__["Location"] }
];
...
module.exports = __webpack_require__(/*! D:\2019下\web前端\myschool2\src\main.ts */"./src/main.ts");
